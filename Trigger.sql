...
INSERT INTO Library VALUES
	(1, 'Rhutuja', 'DBMS', '2021-07-21', 300),
	(2, 'Vaishnavi', 'CNS', '2021-05-21', 500),
	(3, 'Bhagyashree', 'SPOS', '2021-07-10', 400),
	(4, 'Rohini', 'OOP', '2021-08-16', 250),
	(5, 'Rohit', 'DSA', '2021-06-26', 650),
	(6, 'Sachin', 'OOP', '2021-01-01', 330),
	(7, 'Sam', 'SPOS', '2021-02-18', 540),
	(8, 'Aadya', 'CNS', '2021-01-31', 540),
	(9, 'Mamta', 'DBMS', '2021-04-04', 820),
	(10, 'Aditi', 'PPL', '2021-03-07', 430);
...
UPDATE Library SET stu_name = "Tushar" WHERE stu_name = "Vaishnavi";
UPDATE Library SET stu_name = "Tushar" WHERE stu_name = "Mamta";
DELETE FROM Library WHERE stu_name = "Sam";
